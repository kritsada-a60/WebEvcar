...
const ForgotPassword: React.FunctionComponent<IForgotPasswordProps> = (props) => {
    ...
    return (
      <div>
        ...
        <form>
          <label>
            <input type="text" name="username" style={{width:'36.250vw',height:'3.704vh',position: 'absolute', zIndex:'3' ,left: '53.854vw', top: '60vh',borderLeftWidth: '0px',borderRight: '0px', borderTopWidth: '0px',paddingLeft:'10px',fontSize:'24px'}} placeholder="อีเมล"/>          
          </label>
        </form>
