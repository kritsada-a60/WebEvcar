...
const baseURLTracking = 'https://evcarkmitl.com:5000/car/tracking';
...
const BodyPage: React.FunctionComponent<IBodyPageProps> = (props) => {
    ...
    const Testcolumns = ['ทะเบียนรถ', 'ระยะทาง', 'ปริมาณไฟฟ้าที่ใช้'];
                ...
                <div style={{ width: '100%' }}>
                    <ThemeProvider theme={getMuiTheme()}>
                        <MUIDataTable
                            ...
                            data={post.map((item) => {
                                return [item.ut_id, item.c_mileage, item.retire];
                            })}
                            columns={Testcolumns}
                            options={options}
                        />
