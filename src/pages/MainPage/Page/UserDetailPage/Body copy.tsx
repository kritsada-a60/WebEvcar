...
const baseURL ="http://44.203.251.203:5000/user/login"

const BodyPage: React.FunctionComponent<IBodyPageProps> = (props) => {

    const [post, setpost] = useState(["1","2"]);
    const [mypost, setmypost] = useState<MyDataPost[]>([
        {u_id: 1, u_name: 'admin', ul_id: 1, ut_id: 1}
    ]);
    const [post2, setpost2] = useState<MyDataPost[]>([
        {u_id: 2, u_name: 'admin', ul_id: 1, ut_id: 1}
    ]);
