...
const URLMerkersData = 'http://43.210.67.101:5000/car/list';
const URLMerkersDataStation = 'http://43.210.67.101:5000/station/list';
...
function Map() {
    ...
    const handleActiveMarker = (marker: any) => {
        ...
        if (tmp[0] == 'c') {
            axios
                .post('http://43.210.67.101:5000/car/one', { c_id: tmp[1].toString() })
                .then((res) => {
            ...
            axios
                .post('http://43.210.67.101:5000/station/one', { s_id: tmp[1].toString() })
                .then((res) => {
