    ...
    const handleSubmit = (e: any) => {
        ...
        axios
            ...
            .then((res) => {
                ...
                LS.setItem('USERCTM', res.data.data.ctm_id);
    ...
    return (
        <div>
          ...
          เข้าสู่ระบบ
            ...
            <Button variant="text" style={{ color: 'black', position: 'absolute', zIndex: '3', left: '35.250vw', top: '30.741vh', fontSize: '1.563vw' }} onClick={navigateLoginPage}>
                เข้าสู่ระบบ
            </Button>
            <Button variant="text" style={{ color: 'gray', position: 'absolute', zIndex: '3', left: '53.854vw', top: '81.019vh', fontSize: '24px' }} onClick={navigateForgotPassword}>
                ลืมรหัสผ่าน?
            </Button>

            <img src={ButtonLogin} style={{ position: 'absolute', zIndex: '0', left: '33.250vw', top: '27.741vh' }} />

            <Button variant="text" style={{ color: 'white', position: 'absolute', zIndex: '3', left: '35.250vw', top: '41.667vh', fontSize: '1.563vw' }} onClick={navigateRegister}>
                ลงทะเบียน
            </Button>
        </div>
    );
